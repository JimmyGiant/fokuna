...
export const patternEntries: PatternEntry[] = [
  {
    ...
    slug: "button",
    title: "Button",
    figmaName: "buttons-primary · button-overflow",
    figmaNodeId: "14051:28684",
    category: "Actions",
    implementation: "Button · OverflowButton",
    screenshot: "01_Button.png",
    dimensions: ["28 px", "32 px", "40 px", "48 px", "Overflow 24 px"],
    variantSummary: "4 intents · 3 types · 4 sizes · Overflow inactive/active",
  },
  {
    number: 2,
    slug: "callout",
